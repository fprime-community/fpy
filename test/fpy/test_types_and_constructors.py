...
class TestStructs:
    ...
    def test_get_const_struct_member(self):
        seq = """
...
"""
    ...
    def test_get_member_of_anon_expr(self):
        seq = """
...
"""
    ...
    def test_struct_ctor_var_arg(self):
        seq = """
id: U32 = 111
priority: U32 = 3
...
"""
    ...
    def test_calling_struct_field_should_fail_gracefully(self):
        seq = """
var: Svc.DpRecord = Svc.DpRecord(0, 1, 2, 3, 4, 5, Fw.DpState.UNTRANSMITTED)
var.priority()
"""
    ...
    def test_missing_struct_member(self):
        seq = """
...
"""
    ...
    def test_assign_field_with_type_ann_bad(self):
        seq = """
var: Svc.DpRecord = Svc.DpRecord(0, 1, 2, 3, 4, 5, Fw.DpState.UNTRANSMITTED)
var.priority = 123
if var.priority == 123:
...
"""
    ...
    def test_assign_field_with_type_ann_bad_2(self):
        seq = """
var: Svc.DpRecord = Svc.DpRecord(0, 1, 2, 3, 4, 5, Fw.DpState.UNTRANSMITTED)
var.priority: U8 = 123
"""
    ...
    def test_assign_field_before_declare(self):
        seq = """
var.priority = 123
var: Svc.DpRecord = Svc.DpRecord(0, 1, 2, 3, 4, 5, Fw.DpState.UNTRANSMITTED)
"""
    ...
    def test_set_member_of_anon_expr(self):
        seq = """
...
"""
    ...
    def test_write_struct_array_member_const_idx(self):
...
"""
    ...
    def test_write_struct_array_member_var_idx(self):
...
"""
    ...
    def test_write_struct_array_member_nonzero_history(self):
...
class TestArrays:
    ...
    def test_array_ctor_var_arg(self):
        seq = """
arr_0: U32 = 123
arr_1: U32 = 456
...
"""
    ...
    def test_get_item_of_array(self):
        seq = """
...
"""
    ...
    def test_get_item_of_anon_expr(self):
        seq = """
...
"""
    ...
    def test_assign_array_element_with_type_ann_bad(self):
        seq = """
val: Svc.ComQueueDepth = Svc.ComQueueDepth(0, 0)
val[0]: U8 = 55
"""
    ...
    def test_set_item_of_anon_expr(self):
        seq = """
...
"""
    ...
    def test_get_variable_array_idx(self):
        seq = """
...
"""
    ...
    def test_get_variable_array_idx_oob(self):
        seq = """
val: Svc.ComQueueDepth = Svc.ComQueueDepth(456, 123)
idx: I8 = 2
if val[idx] == 123:
...
"""
        ...
        assert_run_failure(seq, DirectiveErrorCode.ARRAY_OUT_OF_BOUNDS)

    def test_get_variable_array_idx_oob_2(self):
        seq = """
val: Svc.ComQueueDepth = Svc.ComQueueDepth(456, 123)
idx: I8 = -1
if val[idx] == 123:
...
"""
    ...
    def test_set_variable_array_idx_oob(self):
        seq = """
val: Svc.ComQueueDepth = Svc.ComQueueDepth(456, 123)
idx: I8 = 2
val[idx] = 111
...
"""
    ...
    def test_set_variable_array_idx(self):
        seq = """
val: Svc.ComQueueDepth = Svc.ComQueueDepth(456, 123)
idx: I8 = 1
val[idx] = 111
...
"""
    ...
    def test_get_item_of_struct(self):
        seq = """
record: Svc.DpRecord = Svc.DpRecord(0, 1, 2, 3, 4, 5, Fw.DpState.UNTRANSMITTED)
value: U32 = record[0]
"""
    ...
    def test_write_array_elem_struct_member(self):
...
"""
    ...
    def test_write_array_elem_struct_member_var_idx(self):
...
class TestConstFoldEquality:
    ...
    def test_const_fold_struct_eq(self):
...
"""
    ...
    def test_const_fold_struct_neq(self):
...
"""
    ...
    def test_const_fold_enum_eq(self):
...
"""
    ...
    def test_const_fold_enum_neq(self):
...
"""
    ...
    def test_const_fold_array_eq(self):
...
"""
    ...
    def test_const_fold_array_neq(self):
...
"""
    ...
    def test_runtime_array_equality(self):
...
"""
    ...
    def test_runtime_enum_equality(self):
...
class TestTypeErrors:
    ...
    def test_enum_constant_as_type(self):
...
"""
        assert_compile_failure(seq, match="Unknown type")

    def test_u8_too_large(self):
        seq = """
var: U8 = 123
var = 256
"""
...
"""
    ...
    def test_int_literal_as_float(self):
        seq = """
var: F32 = 1
if var == 1.0:
    exit(0)
...
"""
    ...
    def test_literal_float_coercion_overflow(self):
        seq = """
...
"""
    ...
    def test_const_float_downcast_rounding(self):
        rounding_seq = """
narrow: F32 = 16777217.0
assert F64(narrow) == 16777216.0
"""

        assert_run_success(rounding_seq)

    def test_const_float_overflow(self):
        overflow_seq = """
narrow: F32 = 3.5e38
"""

        assert_compile_failure(overflow_seq)

    def test_calling_variable_should_fail_gracefully(self):
        seq = """
x: U32 = 1
x()
"""
...
class TestConstCasts:
    ...
    def test_signed_int_const_casts(self):
        seq = """
assert I8(-256) == 0
assert I8(-129) == 127
assert I16(-65536) == 0
...
"""
    ...
    def test_unsigned_int_const_casts(self):
        seq = """
assert U8(-1) == 255
assert U8(256) == 0
assert U16(-1) == 65535
...
"""
    ...
    def test_float_const_casts(self):
        seq = """
assert F32(0.5) == 0.5
...
"""
    ...
    def test_float_to_signed_int_const_casts(self):
        seq = """
assert I8(-128.0) == -128
assert I8(127.0) == 127
...
"""
    ...
    def test_float_to_unsigned_int_const_casts(self):
        seq = """
assert U8(0.0) == 0
assert U8(255.0) == 255
...
"""
    ...
    def test_signed_int_to_float_const_casts(self):
        seq = """
...
"""
    ...
    def test_unsigned_int_to_float_const_casts(self):
        seq = """
...
class TestRuntimeCasts:
    ...
    def test_signed_int_runtime_casts(self):
        seq = """
src: I64 = -256
assert I8(src) == 0
...
"""
    ...
    def test_unsigned_int_runtime_casts(self):
        seq = """
signed_src: I64 = -1
...
"""
    ...
    def test_float_runtime_casts(self):
        seq = """
wide_src: F64 = 0.5
...
"""
    ...
    def test_float_to_signed_int_runtime_casts(self):
        seq = """
f_src: F64 = -128.0
assert I8(f_src) == -128
...
"""
    ...
    def test_float_to_unsigned_int_runtime_casts(self):
        seq = """
f_src: F64 = 0.0
assert U8(f_src) == 0
...
"""
    ...
    def test_signed_int_to_float_runtime_casts(self):
        seq = """
i_src: I32 = -128
...
"""
    ...
    def test_unsigned_int_to_float_runtime_casts(self):
        seq = """
u_src: U32 = 0
...
"""
    ...
    def test_downcast_large_literal(self):
        seq = """
...
class TestOutOfRangeFloatCasts:
    ...
    def test_signed_32bit_overflow(self):
    ...
    def test_signed_32bit_underflow(self):
...
class TestNamedArgsInCtors:
    ...
    def test_named_arg_type_ctor(self):
...
"""
    ...
    def test_named_arg_struct_ctor(self):
...
"""
    ...
    def test_named_arg_coercion_int_to_float(self):
...
"""
    ...
    def test_named_arg_coercion_narrow_to_wide(self):
...
"""
    ...
    def test_named_arg_coercion_reordered(self):
...
class TestNonConstSized:
    ...
    def test_non_const_sized_var_decl(self):
...
"""
    ...
    def test_non_const_sized_func_param(self):
...
"""
    ...
    def test_non_const_sized_func_return(self):
...
"""
    ...
    def test_non_const_sized_ctor_call(self):
...
class TestConstructorDefaults:
    ...
    def test_struct_ctor_all_defaults(self):
...
"""
    ...
    def test_struct_ctor_partial_defaults(self):
...
"""
    ...
    def test_struct_ctor_override_all_defaults(self):
...
"""
    ...
    def test_array_ctor_all_defaults(self):
...
"""
    ...
    def test_array_ctor_partial_defaults(self):
...
"""
    ...
    def test_struct_ctor_enum_member_default(self):
...
"""
    ...
    def test_array_elem_non_first_struct_member(self):
