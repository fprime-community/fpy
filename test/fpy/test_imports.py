...
"""
        ...
        assert_run_success(main, import_directories=[str(tmp_path)])

    def test_local_and_imported_names_coexist(self, tmp_path):
...
"""
    ...
    def test_side_effecting_import_is_error(self, tmp_path):
...
"""
    ...
    def test_functions_only_sequence_compiles(self, tmp_path):
        _write_sequence(
            tmp_path,
            "clean",
            """\
...
"""
    ...
    def test_underscore_module_access_warns(self, tmp_path):
...
"""
    ...
    def test_underscore_from_import_warns(self, tmp_path):
...
"""
    ...
    def test_star_import_does_not_bind_underscore_names(self, tmp_path):
...
"""
        assert_compile_failure(
            main, match="Unknown callable '_helper'", import_directories=[str(tmp_path)]
        )

    def test_star_import_binds_public_names(self, tmp_path):
...
"""
    ...
    def test_library_internal_use_does_not_warn(self, tmp_path):
...
"""
    ...
    def test_underscore_alias_statement_warns_but_uses_do_not(self, tmp_path):
...
class TestImportErrors:
    ...
    def test_cannot_import_sequence_with_arguments(self, tmp_path):
        _write_sequence(
            tmp_path,
            "with_arguments",
            """\
...
"""
        assert_compile_failure(
            main, match="sequence arguments", import_directories=[str(tmp_path)]
        )
...
"""
        assert_compile_failure(main, import_directories=[str(tmp_path)])

    def test_no_arg_sequence_is_importable(self, tmp_path):
...
"""
    ...
    def test_imported_sequence_metadata_must_be_first(self, tmp_path):
...
class TestImporterWithArguments:
    ...
    def test_importer_declares_args_and_imports(self, tmp_path):
        _write_sequence(
            tmp_path,
            "lib",
            """\
...
"""
        ...
        assert state.warnings == []
        assert_run_success(
            main, args=[FpyValue(U32, 41)], import_directories=[str(tmp_path)]
        )
...
class TestImportBuiltinLibrary:
    ...
    def test_imported_sequence_can_use_time_builtin(self, tmp_path):
...
"""
    ...
    def test_imported_sequence_can_use_time_operators(self, tmp_path):
...
"""
        assert_run_success(main, import_directories=[str(tmp_path)], time_base=2)


class TestImportFileErrors:
    """Failure modes rooted in the imported file itself."""

    def test_parse_error_in_imported_file_fails(self, tmp_path):
...
"""
    ...
    def test_import_path_is_a_directory_fails(self, tmp_path):
...
"""
    ...
    def test_empty_sequence_compiles_without_warning(self, tmp_path):
...
class TestImportIsolation:
    ...
    def test_imported_symbol_requires_qualification(self, tmp_path):
...
"""
    ...
    def test_sequence_name_not_usable_as_value(self, tmp_path):
...
"""
        ...
        assert_compile_failure(
            main, match="Unknown value 'lib'", import_directories=[str(tmp_path)]
        )

    def test_same_function_name_in_two_sequences_no_collision(self, tmp_path):
        _write_sequence(
            tmp_path,
            "lib_a",
            """\
...
"""
    ...
    def test_imported_function_cannot_see_importer_globals(self, tmp_path):
...
class TestImportNameCollisions:
    ...
    def test_import_collides_with_local_function(self, tmp_path):
...
"""
    ...
    def test_import_collides_with_local_variable(self, tmp_path):
...
"""
    ...
    def test_import_coexists_with_local_variable(self, tmp_path):
...
class TestImportedSequenceShadowingBuiltins:
    ...
    def test_nested_import_alias_shadowing_builtin_cast_warns(self, tmp_path):
...
""",
    ...
    def test_imported_sequence_cannot_declare_top_level_flags(self, tmp_path):
...
""",
    ...
    def test_nested_import_shadowing_dictionary_module_warns(self, tmp_path):
...
class TestImportShadowsBuiltins:
    ...
    def test_import_shadowing_builtin_warns(self, tmp_path):
...
""",
    ...
    def test_from_import_alias_shadowing_builtin_warns(self, tmp_path):
...
""",
    ...
    def test_imported_sequence_function_shadowing_builtin_warns(self, tmp_path):
...
""",
    ...
    def test_import_over_local_definition_is_error(self, tmp_path):
...
class TestImportDuplicates:
    ...
    def test_import_same_sequence_twice_is_idempotent(self, tmp_path):
...
"""
    ...
    def test_duplicate_across_files_is_allowed(self, tmp_path):
...
class TestImportOnlyAtTopLevel:
    ...
    def test_import_inside_if_block_fails(self, tmp_path):
        _write_sequence(
            tmp_path,
            "lib",
            """\
...
"""
    ...
    def test_import_inside_function_fails(self, tmp_path):
        _write_sequence(
            tmp_path,
            "lib",
            """\
...
class TestImportTransitive:
    ...
    def test_transitive_import_works(self, tmp_path):
...
"""
    ...
    def test_transitive_dependency_is_private(self, tmp_path):
...
"""
    ...
    def test_mutual_import(self, tmp_path):
...
class TestImportDottedPaths:
    ...
    def test_single_dotted_import(self, tmp_path):
...
"""
    ...
    def test_deeply_nested_dotted_import(self, tmp_path):
...
"""
    ...
    def test_dotted_symbol_requires_full_path(self, tmp_path):
...
"""
    ...
    def test_missing_leaf_in_existing_directory_is_error(self, tmp_path):
...
"""
    ...
    def test_two_sequences_in_same_module_no_collision(self, tmp_path):
...
class TestImportFileDirectoryConflict:
    ...
    def test_file_and_directory_same_name_is_error(self, tmp_path):
...
"""
    ...
    def test_file_and_directory_conflict_on_dotted_descent(self, tmp_path):
...
"""
    ...
    def test_bare_directory_import_is_error(self, tmp_path):
...
"""
    ...
    def test_dotted_leaf_directory_import_is_error(self, tmp_path):
...
class TestImportDirectories:
    ...
    def test_sequence_found_in_later_import_directory(self, tmp_path):
...
assert x == 9
"""
        assert_run_success(main, import_directories=[str(d1), str(d2)])

    def test_same_name_in_two_dirs_first_wins(self, tmp_path):
...
"""
    ...
    def test_first_identifier_pins_the_import_directory(self, tmp_path):
...
"""
    ...
    def test_dotted_sequence_resolved_across_import_directories(self, tmp_path):
...
"""
    ...
    def test_no_import_directories_cannot_resolve(self, tmp_path):
...
class TestImportVariables:
    ...
    def test_top_level_variable_is_error(self, tmp_path):
        _write_sequence(
            tmp_path,
            "with_variable",
            """\
...
class TestImportMember:
    ...
    def test_import_member_is_error(self, tmp_path):
...
"""
    ...
    def test_import_member_of_dotted_sequence_is_error(self, tmp_path):
...
"""
    ...
    def test_error_suggests_from_import(self, tmp_path):
...
"""
        assert_compile_failure(
            main, match="from lib import add_one", import_directories=[str(tmp_path)]
        )

    def test_path_past_member_is_error(self, tmp_path):
...
class TestImportAlias:
    ...
    def test_import_sequence_as_alias(self, tmp_path):
...
"""
    ...
    def test_dotted_import_as_alias(self, tmp_path):
...
"""
    ...
    def test_alias_hides_chain(self, tmp_path):
...
"""
    ...
    def test_alias_collides_with_local(self, tmp_path):
...
"""
    ...
    def test_from_import_reexported_module(self, tmp_path):
...
"""
    ...
    def test_from_dotted_sequence(self, tmp_path):
...
"""
    ...
    def test_from_import_as_alias(self, tmp_path):
...
"""
    ...
    def test_from_import_multiple_members(self, tmp_path):
...
"""
    ...
    def test_from_import_multiple_with_aliases(self, tmp_path):
...
"""
    ...
    def test_from_import_parenthesized_single_line(self, tmp_path):
...
"""
    ...
    def test_from_import_parenthesized_multiline(self, tmp_path):
...
"""
    ...
    def test_from_import_duplicate_member_warns(self, tmp_path):
...
"""
    ...
    def test_duplicate_warning_is_per_member_not_per_definition(self, tmp_path):
...
"""
    ...
    def test_from_import_one_name_two_members_is_error(self, tmp_path):
...
"""
    ...
    def test_from_import_does_not_introduce_sequence_name(self, tmp_path):
...
"""
    ...
    def test_from_import_missing_member_is_error(self, tmp_path):
...
"""
    ...
    def test_from_path_past_sequence_file_is_error(self, tmp_path):
...
"""
    ...
    def test_from_import_collides_with_local(self, tmp_path):
...
"""
    ...
    def test_from_star_collides_across_sequences(self, tmp_path):
...
"""
    ...
    def test_from_import_side_effects_is_error(self, tmp_path):
...
class TestImportDuplicateSequence:
    ...
    def test_import_and_from_same_sequence_coexist(self, tmp_path):
...
"""
    ...
    def test_two_from_same_sequence_coexist(self, tmp_path):
...
"""
    ...
    def test_from_import_repeated_across_statements_folds(self, tmp_path):
...
class TestImportDiamond:
    ...
    def test_star_import_diamond_folds(self, tmp_path):
...
"""
    ...
    def test_member_import_diamond_folds(self, tmp_path):
...
class TestImportRelative:
    ...
    def test_relative_import_of_sibling(self, tmp_path):
...
"""
    ...
    def test_absolute_import_ignores_importer_directory(self, tmp_path):
...
"""
    ...
    def test_relative_import_does_not_search_base_path(self, tmp_path):
...
"""
    ...
    def test_relative_binds_path_after_dots(self, tmp_path):
...
"""
    ...
    def test_relative_alias(self, tmp_path):
...
"""
    ...
    def test_bare_dot_from_is_error(self, tmp_path):
...
"""
        assert_compile_failure(
            main, import_directories=[str(tmp_path)], main_file_dir=str(tmp_path)
        )

    def test_relative_import_in_main(self, tmp_path):
...
assert x == 6
"""
        assert_run_success(main, import_directories=[], main_file_dir=str(tmp_path))

    def test_imported_lib_relative_import_anchors_at_the_lib(self, tmp_path):
...
"""
        assert_run_success(
            main, import_directories=[str(d_lib)], main_file_dir=str(d_app)
        )

    def test_over_deep_relative_has_no_anchor_directory(self, tmp_path):
    ...
    def test_relative_import_without_location_is_error(self, tmp_path):
...
"""
    ...
    def test_relative_and_absolute_same_file_idempotent(self, tmp_path):
...
class TestImportModuleMerging:
    ...
    def test_sibling_modules_merge(self, tmp_path):
...
"""
    ...
    def test_file_and_directory_same_name_cannot_even_resolve(self, tmp_path):
...
"""
    ...
    def test_two_different_directories_same_name_collide(self, tmp_path):
...
"""
    ...
    def test_directory_and_sequence_same_name_forbidden(self, tmp_path):
...
"""
    ...
    def test_two_aliases_same_name_collide(self, tmp_path):
...
"""
    ...
    def test_relative_and_absolute_leaf_collision(self, tmp_path):
