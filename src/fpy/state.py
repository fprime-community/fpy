...
class CompileState:
    ...
    seq_dependencies: dict[str, list[FpyType]] = field(default_factory=dict)
    """Map of .bin filename to resolved argument types, populated by ResolveSequenceDependencies."""
