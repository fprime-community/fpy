...
class CompileState:
    ...
    sequence_arg_type_names: list[str] = field(default_factory=list)
    """Ordered list of sequence argument type names (e.g. ["U32", "Svc.DpRecord"]).
    Populated during semantic analysis and embedded in the output binary header."""
